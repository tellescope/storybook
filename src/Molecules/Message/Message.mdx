...
import * as MessageInputStories from './Message.stories';
...
The complete message input interface in its default state, ready for user interaction.

<Canvas of={MessageInputStories.Default} />
